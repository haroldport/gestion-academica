...
public class IndexBean implements Serializable {
    ...
    public void preinscribirCliente(){
    	...
    	if(preinscripcionTmp == null){
    		...
    		preinscripcion.setObservacion("Preinscripci�n en el curso: " + cursoSeleccionado.getInformacionCurso().getNombre());
    		preinscripcionServicio.crear(preinscripcion);
    		bitacora = new Bitacora(fechaCreacion, "Preinscripci�n a curso: " + cursoSeleccionado.getInformacionCurso().getNombre()
    		...
    		msg = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Ya est�s preinscrito en este curso","");
    	}
    	FacesContext.getCurrentInstance().addMessage(null, msg);
    }
