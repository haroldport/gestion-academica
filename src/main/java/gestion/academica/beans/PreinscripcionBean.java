...
public class PreinscripcionBean extends Utilitario implements Serializable {
	...
	public void matricularCliente(){
		...
		if(preinscripcionSeleccionada.getCurso().getCupoDisponible() > 0){
			...
			Curso cursoTmp = preinscripcionSeleccionada.getCurso();
			cursoTmp.setCupoDisponible(cursoTmp.getCupoDisponible() - 1);
			cursoServicio.editar(cursoTmp);
			...
			ponerMensajeError("No hay cupos disponibles en este Curso", "");
		}		
	}
