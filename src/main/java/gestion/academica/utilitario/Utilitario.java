...
public class Utilitario implements Serializable {
	...
	/**
	 * Metódo que retorna la resta de dos fechas en días.
	 * 
	 * @param fechaDesde
	 * @param fechaHasta
	 * @return dias
	...
	public boolean validarRuc(String valor) {
        ...
        if (!(codProv < 24 && codProv > 1)) {// codigo provincia no mayor a
            // 24 ni menor a 1
        	ponerMensajeError("Código de provincia no mayor a 24 ni menor a 1.", "");
            return Boolean.FALSE;
        }

        if (Character.digit(arr[2], 10) == 7
                || Character.digit(arr[2], 10) == 8) {
        	ponerMensajeError("El tercer dígito del RUC no puede ser 7 u 8.", "");
            return Boolean.FALSE;
        }
        ...
        if (Character.digit(arr[2], 10) < 6) // CEDULA
        {
            ...
            if (res == Character.digit(arr[arr.length - diff], 10)) {
            	...
            	ponerMensajeError("RUC de persona natural no es válido.", "");
                return Boolean.FALSE;
            }
        }
        ...
        if (Character.digit(arr[2], 10) == 6) // 6
        {
            ...
            if (Character.digit(arr[8], 10) == digit) {
            	...
            	ponerMensajeError("RUC de sociedad pública no es válido.", "");
                return Boolean.FALSE;
            }
        }
        ...
        // COEFICIENTES = 4.3.2.7.6.5.4.3.2
        {
            ...
            if (Character.digit(arr[9], 10) == digit) {
            	...
            	ponerMensajeError("RUC de sociedad privada no es válido.", "");
                return Boolean.FALSE;
            }
        }
        return Boolean.TRUE;
	...
	/**
     * MÃ©todo usado para recuperar mensajes desde el archivo de propiedades de
     * la aplicacion.
     *
     ...
     * parÃ¡metros necesarios para completar el mensaje
    ...
    /**
     * Obtener el tamaÃ±o de los campos de cada uno de los registros del archivo.
     * @param linea
     * @return
     */
